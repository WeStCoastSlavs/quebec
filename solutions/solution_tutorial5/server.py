...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 21 16:07:04 2016
"""
...
class Server:
 ...
 def __init__(self, port = 80):
     """ Constructor """
     self.host = 'localhost' # <-- works on all available network interfaces
     self.port = port
 ...
 def _wait_for_connections(self):
     ...
     while True:
         ...
         if (request_method == 'GET') | (request_method == 'HEAD'):
             ...
             if file_requested=="/chatinfo":
                 print "handling the chat request!"
                 response_headers = self._gen_headers( 200)

                 server_response = response_headers.encode() # return headers for GET and HEAD

                 name = raw_input("Enter message: ")

                 if (request_method == 'GET'):
                     server_response += b"<p>"+name+"</p>"
